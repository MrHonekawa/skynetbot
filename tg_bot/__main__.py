...
I am a cute, group care taking robot!

You need more help, sawaadeee! Lets proceed with /help

"""

HELP_STRINGS = """
Hey there I am *{}*
*Cute* commands available:
 - /start: start the cutie bot.
 - /help: Sends you this message!
 - /help <module name>: Sends you INFO about that module.
 - /settings:
   - in DM: will send you (your) settings for all supported modules!
   - in a group: will redirect you to pm, with chat settings!
{}
And following:
...
def start(bot: Bot, update: Update, args: List[str]):
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text("Yeey, I am Already Working for you all!")
